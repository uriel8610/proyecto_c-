    ...
    public partial class principal : Form
    {
        ...
        private void btAgregar_AU_Click(object sender, EventArgs e)
        {
            ...
            else if ((chFemenino_AU.Checked == true && chMasculino_AU.Checked == false) || (chFemenino_AU.Checked == false && chMasculino_AU.Checked == true))
            {
                ...
                /// Insercion a la Base de datos a la tabla Persona 
                /// </summary> 
                txtFecha_AU.Text = fecha.ToString();
                consulta = " INSERT INTO Persona( Nombre, Apellido, Direccion, Telefono, eMail, Edad, Sexo, fecha )VALUES('" + txtNombre_AU.Text + "','" + txtApellido_AU.Text + "','" + txtDireccion_AU.Text + "','" + txtDireccion_AU.Text + "', '" + txtEmail_AU.Text + "'," + txtEdad_AU.Text + ",'" + sexo + "', '" + txtFecha_AU.Text + "');";
                c1.Abrir();
                c1.actualizar(consulta);
                c1.cerrar();
